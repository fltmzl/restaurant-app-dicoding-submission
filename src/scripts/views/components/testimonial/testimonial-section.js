      ...
      <div class="testimonials container">
        ...
        <div class="testimonials__container">
          <section class="testimonial">
            <img class="testimonial__img" src="/images/profile-1.jpg" alt="profil user" width="70" height="70" loading="lazy" />
            ...
            <blockquote class="testimonial__body">
              ...
              <img class="testimonial__icon" src="https://img.icons8.com/ios-glyphs/90/000000/quote-left.png" alt="quote-left-icon" loading="lazy" />
            </blockquote>
          </section>
          <section class="testimonial testimonial-black">
            <img class="testimonial__img" src="/images/profile-2.jpg" alt="profil user" width="70" height="70" loading="lazy" />
            ...
            <blockquote class="testimonial__body">
              ...
              <img class="testimonial__icon" src="https://img.icons8.com/ios-glyphs/90/ecc92c/quote-left.png" alt="quote-left-icon" loading="lazy" />
            </blockquote>
          </section>
          <section class="testimonial">
            <img class="testimonial__img" src="/images/profile-3.jpg" alt="profil user" width="70" height="70" loading="lazy" />
